...
{
    [CreateAssetMenu(fileName = "AdditionalEngine", menuName = "ScriptableObjects/Configuration/AdditionalEngine")]
    public class AdditionalEngineConfig : BaseConfigurationConfig
    {
